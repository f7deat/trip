    ...
    return (
        <footer className="text-gray-500 bg-gray-900 relative p-4">
                ...
                <div className="md:flex mb-2 mt-4">
                    <div className="md:w-1/3 mb-3">
                        ...
                        <div className="mb-3">
                            <form className="form-inline">
                                ...
                                <button type="button" className="py-2 px-3 bg-green-600 text-white hover:bg-green-700 rounded">Đăng ký</button>
                            </form>
                        </div>
                    ...
                    <div className="md:w-1/3 mb-3">
                        ...
                        <div className="link mt-2">
                            ...
                            <div><i className="fab fa-cloudsmith" /> Hosted by <a href="https://vercel.com/" target="_blank" className="text-gray-500 font-bold" rel="noreferrer">Vercel</a></div>
                        </div>
                    </div>
                    <div className="md:w-1/3 mb-3">
                        <div className="font-bold mb-2"><i className="fa fa-bars" /> LIÊN KẾT</div>
                        <div className="mb-3">
                            <a href="https://github.com/f7deat" className="mr-1 border border-solid border-green-600 text-green-600 py-1 px-2 hover:bg-green-600 hover:text-white text-upercase inline-block">Repositories</a>
                            <a href="https://github.com/def-zone" className="mr-1 border border-solid border-green-600 text-green-600 p-1 px-2 hover:bg-green-600 hover:text-white text-upercase inline-block">Organization</a>
                        </div>
                        <div className="my-2">
            ...
            <div className="text-center pt-2 border-t border-gray-600">© 2019 -
                <a href="https://defzone.net" target="_blank" rel="noreferrer" className="font-bold text-gray-500">
                    <span>DefZone.Net</span>
                </a> - <a className="font-bold text-gray-500" href="https://defzone.net/home/privacy" target="_blank" rel="noreferrer">Privacy</a></div>
        </footer>
